...
export interface ApiActionAction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['atelier', 'accompagnement', 'prevention', 'sensibilisation', 'autre']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiActionsPageActionsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    actionsIntro: Schema.Attribute.Blocks;
    actionsTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Que fait-on ?'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whereWeAreGoing: Schema.Attribute.Blocks;
    whereWeAreGoingTitle: Schema.Attribute.String;
  };
}
...
export interface ApiHouseHouse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about_pages: Schema.Attribute.Relation<
      ...
      'api::about-page.about-page'
    >;
    action: Schema.Attribute.Relation<'oneToMany', 'api::action.action'>;
    address: Schema.Attribute.String & Schema.Attribute.Required;
    city: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultLocale: Schema.Attribute.Enumeration<['fr', 'eu']>;
    ...
    joins: Schema.Attribute.Relation<'oneToMany', 'api::join.join'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiJoinJoin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    financialText: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    financialTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    patronText: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    patronTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volunteerText: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['works_with_us', 'funders']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['juridique', 'sante', 'social', 'prevention', 'documentation', 'autre']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
